...
import teamhollow.readyyourshovels.world.feature.AntHillStructure;
...
public class RYSStructures {
    ...
    public static void registerStructure(RegistryEvent.Register<Structure<?>> registry) {
        ...
        registry.getRegistry().register(ANT_HILL.setRegistryName(ReadyYourShovels.MODID, "ant_hill"));
