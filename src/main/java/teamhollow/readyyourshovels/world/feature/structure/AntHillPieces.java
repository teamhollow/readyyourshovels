package teamhollow.readyyourshovels.world.feature.structure;
...
import teamhollow.readyyourshovels.registry.RYSStructurePieces;

import java.util.List;
import java.util.Random;

public class AntHillPieces {
    private static final ResourceLocation ant_hill = new ResourceLocation(ReadyYourShovels.MODID, "ant_hill");
